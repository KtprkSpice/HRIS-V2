            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <button type="button"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="shrink-0 w-5 h-5 text-gray-500 dark:text-gray-400 transition duration-75 group-hover:dark:text-white group-hover:text-gray-900">
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        <li>
                            <a href="{{ route('employees.index') }}"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Employees
                                List</a>
                        </li>
                        <li>
                ...
                <li>
                    <button type="button"
                        ...
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Divison</span>
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" d="m1 1 4 4 4-4" />
                ...
                <li>
                    <a href="{{ url('/leave-request') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Leave Requests</span>
                    </a>
                </li>
                <li>
                    <a href="{{ url('/roles') }}"
